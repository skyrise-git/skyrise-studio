...
import { PencilLine, SendHorizontal, ArrowLeft, Loader2, Upload, ImageIcon, X } from 'lucide-react';
...
export default function EditProjectPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setIsUploading(true);
    try {
      // Downscale/Compress image for Base64 storage
      ...
      reader.onload = (event) => {
        ...
        img.onload = () => {
          ...
          toast({
            ...
            description: "Image optimized for storage.",
          });
  ...
  const handleProjectSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Data prepared. Sending update to Firebase...");
      ...
      console.error("CRITICAL Error updating project:", err);
      toast({
        title: "Database Error",
        description: err.message || "Failed to update. Image might be too large.",
        variant: "destructive",
      });
    } finally {
      setIsSubmitting(false);
